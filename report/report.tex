...
We compared the function \texttt{my\_cg} with \texttt{scipy.sparse.linalg.cg} and found out that, fixing relative tolerance the number of iteration is approximately the same.
